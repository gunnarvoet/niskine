...
# %% [markdown]
# # NISKINe Near-Inertial Wave Fluxes
...
# - deepest instrument less than 1000m from the bottom
# - sampling interval less than 3 hours
# - water depth > 3200m
...
# %%
os4.ctd.p.plot(hue='nomz', add_legend=False);

# %% [markdown]
# `MM3` only has one current meter at depth, but it has a complete record. We could probably fit the first mode.
...
# %% [markdown]
# Pick a shorter time range for testing.
...
# %%
N = niskine.flux.Flux(mooring=m1, bandwidth=1.03, runall=True)
