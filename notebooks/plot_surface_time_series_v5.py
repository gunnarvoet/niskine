...
# %% [markdown]
# # NISKINe Plot Surface Time Series v5

# %% [markdown]
# Change from v4:
# - Do no WKB-scale $\mathrm{NI}_\mathrm{KE}$.
...
# %%
# load NI EKE WKB-scaled
ni_eke_wkb = xr.open_dataarray(cfg.data.ni_eke_m1)
ni_eke_wkb.close()
...
# %%
out = niskine.calcs.ni_ke_by_vort_and_wind(wkb=False)
